...
\begin{document}
  ...
  \section{ Testing existing code (FizzBuzz) }
    \paragraph{}
  ...
  \section{ Test-driven development (FizzBuzz) }
    \paragraph{}
...
int f(int x){
  ...
  \section{ Contemplation (TDD vs TAD) }
    \paragraph{}
...
\section{ Contemplation (Test-coverage) }
  \paragraph{}
